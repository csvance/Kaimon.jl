...
include("truncate_output_tests.jl")
include("tools_config_tests.jl")
include("test_backgrounding_tests.jl")
include("version_tests.jl")
include("qdrant_indexer_tests.jl")
include("qdrant_hybrid_tests.jl")
include("qdrant_server_tests.jl")
include("grep_code_tests.jl")
include("edit_code_tests.jl")
include("rename_symbol_tests.jl")
...
include("gate_tool_merge_tests.jl")
